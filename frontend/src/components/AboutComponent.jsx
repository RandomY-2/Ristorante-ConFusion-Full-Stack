  ...
  return (
    <div class="d-flex align-items-center mt-3">
      <div class="flex-shrink-0">
        <img src={getUrl(leader.image)} alt={leader.name} />
      </div>
...
const LeaderList = ({ leaderList, leaderLoading, leaderErrMess }) => {
...
const About = () => {
  ...
  const leaderErrMess = useSelector(state => state.leader.errMess);
